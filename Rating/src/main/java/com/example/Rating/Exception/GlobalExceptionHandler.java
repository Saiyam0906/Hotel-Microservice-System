...
import com.example.Rating.dto.Response.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    // 3. Broken JSON or wrong data types in request body
    ...
    // 4. Catch-all — DB down, NullPointer, anything unexpected
